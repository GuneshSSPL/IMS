...
export const createMaterial = async (req, res) => {
  const { MaterialCode, Description, CategoryID, UOM, UnitPrice, CurrentQuantity } = req.body;
  ...
  try {
    ...
    await pool.request()
      ...
      .query(`
        INSERT INTO Materials (MaterialCode, Description, CategoryID, UOM, UnitPrice, CurrentQuantity)
        VALUES (@MaterialCode, @Description, @CategoryID, @UOM, @UnitPrice, @CurrentQuantity)
      `);
